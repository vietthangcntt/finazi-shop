...
$sidebar_woocommerce = array(
	 'name' => __('Main sidebar__woocommerce', 'finazi'),
	 'id' => 'main-sidebar__woocommerce',
	 'description' => 'Main sidebar shop finazi',
	 'class' => 'main-sidebar__woocommerce',
	 'before_title' => '<h3 class="widgettitle__woocommerce">',
	 'after_title' => '</h3>'
);
...
if ( ! function_exists( 'finazi_car' ) ) {
	function finazi_car() {?>
		<div class="shop">
			<a href="<?php echo wc_get_cart_url() ?>"><img src="<?php echo get_stylesheet_directory_uri()?>/images/shop.png" alt="My icon"><span><?php echo  WC()->cart->get_cart_contents_count() ?></span></a>
...
**/
	...
	if (! function_exists('finazi_home')) {
		function finazi_home(){
			...
			// $title= the_title();
			if (is_home()) { ?>
			<h1 class="page-title"> <?php echo esc_html('HOME'); ?> </h1>
			...
			<?php }
				...
				if (is_single()) { ?>
					<h1 class="page-title"> <?php echo esc_html('SHOP (DETAIL)'); ?> </h1>
					<li class="home-item"><a href="'.$home.'">Home</a></li>
					<li class="home-item-2"><span>Shop</span></li>
					<?php
				}

				if (is_shop()) { ?>
					<h1 class="page-title"> <?php echo esc_html('SHOP'); ?> </h1>
					<li class="home-item"><a href="'.$home.'">Home</a></li>
					<li class="home-item-2"><span>Shop</span></li>
				 <?php }

				 if (is_cart()) { ?>
				 	<h1 class="page-title"> <?php echo esc_html('SHOP (CART)'); ?> </h1>
				 	<li class="home-item"><a href=" .$home.">Home</a></li>
				 	<li class="home-item-2"><span>Shop</span></li>
				 ...
				 if (is_checkout()) { ?>
				 	<h1 class="page-title"> <?php echo esc_html('CHECK OUT'); ?></h1>
			 		<li class="home-item"><a href=" .$home. ">Home </a></li>
			 		<li class="home-item-2"><span><?php echo esc_html('Shop'); ?></span></li>
				 <?php }
 ...
 */
	function finazi_readmore() {
			return '<div class="read"><a class="read-more" href="'. get_permalink( get_the_ID() ) . '">' . __('READ MORE', 'finazi') . '</a></div>';
	}
 ...
 */
	...
	wp_register_style('woocommerce-css',get_template_directory_uri().'/css/woocommerce.css','all');
